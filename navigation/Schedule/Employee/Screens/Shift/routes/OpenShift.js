...
const OpenShifts = (props) => {

    const { openShifts, getAllShift, flatListRef,shifts } = props
    
    console.log(openShifts,'openShift')
...
const mapStateToProps = state => {
    return {
        openShifts: state.employee.schedule.shifts.openShift,
...
export default connect(mapStateToProps, mapDispatchToProps)(OpenShifts)
